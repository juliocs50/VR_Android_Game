...
public class StartOptions : MonoBehaviour {
    ...
    public void StartButtonClickedMult()
    {
        JOGO.SetActive(true);
        sceneToStart = 2;
    ...
    public void StartButtonClickedCredito()
    {
        ...
        public void StartButtonClicked()
	{
		...
		if (menuSettingsData.nextSceneIndex != 0) 
		{
            ...
            StartCoroutine(FadeCanvasGroupAlpha(0f, 6f, fadeOutImageCanvasGroup));
	...
	public void StartGameInScene()
	{
        ...
        StartCoroutine(FadeCanvasGroupAlpha(6f,0f, menuCanvasGroup));
	}
