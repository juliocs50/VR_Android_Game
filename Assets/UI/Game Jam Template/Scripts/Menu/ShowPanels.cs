...
public class ShowPanels : MonoBehaviour {
    ...
    public GameObject optionMultplayer;
    ...
    public void ShowOptionsMultplayer()
    {
        optionMultplayer.SetActive(true);
        PainelPrincipal.SetActive(false);

}
    //Call this function to activate and display the Options panel during the main menu
    public void ShowOptionsPrincipal()
    {
        optionMultplayer.SetActive(false);
