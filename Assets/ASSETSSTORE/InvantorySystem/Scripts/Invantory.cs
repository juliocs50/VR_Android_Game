...
public class Invantory : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.E) || Input.GetKeyDown(KeyCode.JoystickButton9))
        {
            ToggleSlot(true);
        }
    ...
    private void InitGUI()
    {
        ...
        if (even)
        {
          ...
          //  oldPos.x -= (tempGameObject.GetComponent<RectTransform>().rect.width / 0.8f + 0.5f);
        ...
        for (int i = 0; i < maxInvantorySlots / 2; i++)
        {
           ...
           // var oldPos = tempGameObject.GetComponent<RectTransform>().position;
          //  oldPos.x += i * tempGameObject.GetComponent<RectTransform>().rect.width + (i * padding) + (even ? (tempGameObject.GetComponent<RectTransform>().rect.width / 0.8f) +0.5f : 0);
